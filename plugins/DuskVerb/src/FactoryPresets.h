...
inline const std::vector<FactoryPreset>& getFactoryPresets()
{
    static const std::vector<FactoryPreset> presets = {
        ...
        { "Live Room",            "Rooms",
          ...
          0.701f, 0.45f, 0.10f, 0.80f, 0.81f, 1.40f, 317.135f,  // 2026-07-03 Bass 1.666->1.4: lows ran hot+long vs anchor (ss sub +6.3 dB, ss low +3.2, T60-250 +12.9%, cent_500 -68% dark) — the anchor is a BRIGHTER, mid-forward live room. Joint move with mid 0.566->0.75 + Width 1.0->0.9 (stereo_corr -0.34 vs -0.15 over-wide): 31->28.
