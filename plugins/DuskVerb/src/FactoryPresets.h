...
inline const std::vector<FactoryPreset>& getFactoryPresets(){
    static const std::vector<FactoryPreset> presets = {
        ...
        { "Homestar Blade Runner",                    "Halls",      0, 25.7000f, 31.1f, 0.8f, 1.0338f, 1.2222f, 1.5277f, 1.00f, 0.356f, 3.99f, 0.28f, 0.69f, 0.3f, 20.0f, 6004.0f, 1.0f, 0.0f, 50.0f, -7.0f },
        ...
        { "Concert Wave",                             "Halls",      2, 4.9103f, 24.1f, 0.35f, 1.5f, 1.03f, 799.0f, 0.47f, 0.350f, 3.78f, 0.39f, 0.11f, 0.3f, 20.0f, 12263.4f, 1.0f, 0.0f, 50.0f, -8.7f },
        ...
        { "Fat Snare Hall",                           "Halls",      5, 3.8418f, 11.0f, 0.568f, 1.5f, 0.525f, 0.6562f, 0.92f, 1.000f, 0.40f, 0.07f, 0.48f, 0.3f, 20.0f, 4500.0f, 1.0f, 0.0f, 50.0f, -24.43f },
        ...
        { "Long Synth Hall",                          "Halls",      7, 6.6292f, 8.0f, 1.0f, 1.1638f, 0.5782f, 650.0f, 1.00f, 0.492f, 1.13f, 0.25f, 0.70f, 0.3f, 20.0f, 8314.1f, 1.0f, 0.0f, 50.0f, -1.9f },
        ...
        { "Exciting Snare Room",                      "Rooms",      18, 0.4195f, 17.0f, 0.324f, 0.6637f, 1.7f, 799.0f, 1.00f, 0.144f, 0.78f, 0.80f, 0.13f, 0.3f, 20.0f, 6500.0f, 1.0f, 0.0f, 50.0f, -18.7f },
        { "Fat Snare Room",                           "Rooms",      19, 2.7840f, 15.0f, 0.388f, 1.5f, 0.6630f, 0.8288f, 0.94f, 0.05f, 1.50f, 0.50f, 0.18f, 0.3f, 20.0f, 6800.0f, 1.0f, 0.0f, 50.0f, -39.89f },
        ...
        { "Large Wood Room",                          "Chambers",      59, 2.5184f, 0.0f, 0.600f, 1.0722f, 0.5650f, 4000.0f, 0.95f, 0.312f, 0.50f, 0.67f, 0.29f, 0.3f, 20.0f, 10014.1f, 1.0f, 0.0f, 50.0f, -20.46f },
        { "Live Vox Chamber",                         "Chambers",      28, 1.5763f, 0.0f, 0.7001f, 1.4094f, 2.0000f, 2.5000f, 0.80f, 0.360f, 0.32f, 0.15f, 0.36f, 0.3f, 325.9f, 15000.0f, 1.0f, 0.0f, 50.0f, -35.89f },
        ...
        { "Rich Chamber",                             "Chambers",      30, 4.1814f, 25.1f, 0.7f, 1.5f, 1.58f, 3831.0f, 1.00f, 0.160f, 1.30f, 0.05f, 0.39f, 0.3f, 20.0f, 10500.0f, 1.0f, 0.0f, 50.0f, -29.49f },
        { "Small Chamber1",                           "Chambers",      31, 4.5110f, 0.0f, 0.4999f, 1.4681f, 1.9126f, 662.0f, 1.00f, 0.192f, 1.20f, 0.29f, 0.28f, 0.3f, 20.0f, 12502.4f, 1.0f, 0.0f, 50.0f, -23.69f },
        { "Small Chamber2",                           "Chambers",      32, 1.1510f, 0.0f, 0.5001f, 1.3141f, 1.27f, 1079.0f, 1.00f, 0.05f, 1.20f, 0.20f, 0.30f, 0.3f, 80.0f, 15002.4f, 1.0f, 0.0f, 50.0f, -27.09f },
        ...
        { "Big Ambience Gate",                        "Ambience",      39, 0.7830f, 20.0f, 1.0f, 1.4705f, 1.07f, 401.0f, 1.00f, 1.000f, 1.53f, 0.00f, 0.00f, 0.3f, 20.0f, 8000.0f, 1.0f, 450.0f, 120.0f, 2.11f },
        ...
        { "Gated Snare",                              "Ambience",      42, 1.60f, 9.0f, 0.80f, 1.00f, 1.00f, 700.0f, 0.92f, 0.524f, 0.40f, 0.05f, 0.05f, 0.3f, 20.0f, 8000.0f, 1.0f, 338.0f, 8.7f, 0.30f },
        { "Large Ambience",                           "Ambience",      75, 2.3317f, 0.0f, 0.600f, 1.4634f, 0.4000f, 332.0f, 1.00f, 1.000f, 1.50f, 0.00f, 0.00f, 0.3f, 20.0f, 8000.0f, 1.0f, 0.0f, 50.0f, -16.6f },
        ...
        { "Short Vocal Ambience",                     "Ambience",      46, 3.6483f, 23.1f, 0.15f, 1.7f, 1.3268f, 1.6585f, 1.00f, 1.000f, 0.80f, 0.08f, 0.05f, 0.3f, 20.0f, 10500.0f, 1.0f, 0.0f, 50.0f, -21.69f },
        { "Small Ambience",                           "Ambience",      47, 1.6948f, 10.0f, 0.22f, 1.5f, 0.57f, 800.0f, 1.00f, 1.000f, 1.50f, 0.15f, 0.05f, 0.3f, 20.0f, 10500.0f, 1.0f, 0.0f, 50.0f, -15.93f },
        { "Small Drum Room",                          "Ambience",      80, 12.0000f, 11.0f, 0.300f, 0.6000f, 0.6000f, 800.0f, 1.00f, 1.000f, 0.40f, 0.15f, 0.00f, 0.3f, 20.0f, 8000.0f, 2.0f, 0.0f, 50.0f, -16.5f },
