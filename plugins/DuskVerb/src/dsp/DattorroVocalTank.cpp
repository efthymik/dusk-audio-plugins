...
void DattorroVocalTank::DelayLine::allocate (int maxSamples)
{
...
void DattorroVocalTank::DelayLine::clear()
{
    std::fill (buffer.begin(), buffer.end(), 0.0f);
    writePos = 0;
}

float DattorroVocalTank::DelayLine::readInterpolated (float delaySamples) const
{
...
void DattorroVocalTank::Allpass::allocate (int maxSamples)
{
    int bufSize = DspUtils::nextPowerOf2 (maxSamples + 1);
    buffer.assign (static_cast<size_t> (bufSize), 0.0f);
    mask = bufSize - 1;
...
void DattorroVocalTank::Allpass::clear()
{
    std::fill (buffer.begin(), buffer.end(), 0.0f);
    writePos = 0;
}
...
DattorroVocalTank::DattorroVocalTank()
{
...
void DattorroVocalTank::setHallScale (bool enable)
{
    if (enable)
    {
...
void DattorroVocalTank::prepare (double sampleRate, int /*maxBlockSize*/)
{
...
void DattorroVocalTank::process (const float* inputL, const float* inputR,
...
float DattorroVocalTank::readOutputTap (const OutputTap& tap) const
{
...
void DattorroVocalTank::setDecayTime (float seconds)
{
...
void DattorroVocalTank::setBassMultiply (float mult)
{
...
void DattorroVocalTank::setMidMultiply (float mult)
{
...
void DattorroVocalTank::setCrossoverFreq (float hz)
{
...
void DattorroVocalTank::setHighCrossoverFreq (float hz)
{
...
void DattorroVocalTank::setModDepth (float depth)
{
...
void DattorroVocalTank::setModRate (float hz)
{
    modRateHz_ = hz;
    if (prepared_)
        updateLFORates();
...
void DattorroVocalTank::setLimiter (float thresholdDb, float releaseMs)
{
...
void DattorroVocalTank::setSize (float size)
{
...
void DattorroVocalTank::setSoftOnsetMs (float ms)
{
...
void DattorroVocalTank::setDelayScale (float scale)
{
...
void DattorroVocalTank::setOutputTaps (const OutputTap* left, const OutputTap* right)
{
    if (left && right)
    {
...
void DattorroVocalTank::applyTapGains (const float* leftGains, const float* rightGains)
{
...
void DattorroVocalTank::setTankDiffusion (float amount)
{
...
void DattorroVocalTank::setFreeze (bool frozen)
{
...
void DattorroVocalTank::setLateGainScale (float scale)
{
    lateGainScale_ = std::max (scale, 0.0f);
}

void DattorroVocalTank::setSizeRange (float min, float max)
{
...
void DattorroVocalTank::setDecayBoost (float boost)
{
...
void DattorroVocalTank::setStructuralHFDamping (float hz)
{
    lastStructHFHz_ = hz;
    if (hz <= 0.0f)
    {
...
void DattorroVocalTank::clearBuffers()
{
...
void DattorroVocalTank::updateDelayLengths()
{
    float rateRatio = static_cast<float> (sampleRate_ / kBaseSampleRate);
...
void DattorroVocalTank::updateDecayCoefficients()
{
...
void DattorroVocalTank::updateLFORates()
{
