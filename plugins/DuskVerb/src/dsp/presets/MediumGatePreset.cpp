...
// any other preset. The class has been renamed to MediumGatePresetEngine to avoid
// ODR conflicts.

#include "MediumGatePreset.h"
...
namespace {
    ...
    // Baked algorithm-config constants from kPresetMediumGate in AlgorithmConfig.h
...
class MediumGatePresetEngine
{
public:
    MediumGatePresetEngine();
...
void MediumGatePresetEngine::DelayLine::allocate (int maxSamples)
{
...
void MediumGatePresetEngine::DelayLine::clear()
{
    std::fill (buffer.begin(), buffer.end(), 0.0f);
    writePos = 0;
}

float MediumGatePresetEngine::DelayLine::readInterpolated (float delaySamples) const
{
...
void MediumGatePresetEngine::Allpass::allocate (int maxSamples)
{
    int bufSize = DspUtils::nextPowerOf2 (maxSamples + 1);
    buffer.assign (static_cast<size_t> (bufSize), 0.0f);
    mask = bufSize - 1;
...
void MediumGatePresetEngine::Allpass::clear()
{
    std::fill (buffer.begin(), buffer.end(), 0.0f);
    writePos = 0;
}
...
MediumGatePresetEngine::MediumGatePresetEngine()
{
...
void MediumGatePresetEngine::setHallScale (bool enable)
{
    if (enable)
    {
...
void MediumGatePresetEngine::prepare (double sampleRate, int /*maxBlockSize*/)
{
...
void MediumGatePresetEngine::process (const float* inputL, const float* inputR,
                            float* outputL, float* outputR, int numSamples)
{
    if (! prepared_)
        return;
...
float MediumGatePresetEngine::readOutputTap (const OutputTap& tap) const
{
...
void MediumGatePresetEngine::setDecayTime (float seconds)
{
...
void MediumGatePresetEngine::setBassMultiply (float mult)
{
...
void MediumGatePresetEngine::setTrebleMultiply (float mult)
{
...
void MediumGatePresetEngine::setCrossoverFreq (float hz)
{
...
void MediumGatePresetEngine::setHighCrossoverFreq (float hz)
{
...
void MediumGatePresetEngine::setAirDampingScale (float scale)
{
...
void MediumGatePresetEngine::setModDepth (float depth)
{
...
void MediumGatePresetEngine::setModRate (float hz)
{
    modRateHz_ = hz;
    if (prepared_)
        updateLFORates();
...
void MediumGatePresetEngine::setSize (float size)
{
...
void MediumGatePresetEngine::setSoftOnsetMs (float ms)
{
...
void MediumGatePresetEngine::setDelayScale (float scale)
{
...
void MediumGatePresetEngine::setNoiseModDepth (float samples)
{
...
void MediumGatePresetEngine::setOutputTaps (const OutputTap* left, const OutputTap* right)
{
    if (left && right)
    {
...
void MediumGatePresetEngine::applyTapGains (const float* leftGains, const float* rightGains)
{
...
void MediumGatePresetEngine::setFreeze (bool frozen)
{
    frozen_ = frozen;
    if (frozen)
    {
...
void MediumGatePresetEngine::setDecayBoost (float boost)
{
...
void MediumGatePresetEngine::setStructuralHFDamping (float hz)
{
    if (hz <= 0.0f)
    {
        structHFCoeff_ = 0.0f;
...
void MediumGatePresetEngine::setTerminalDecay (float thresholdDB, float factor)
{
...
void MediumGatePresetEngine::updateDelayLengths()
{
    float rateRatio = static_cast<float> (sampleRate_ / kBaseSampleRate);
...
void MediumGatePresetEngine::updateDecayCoefficients()
{
...
void MediumGatePresetEngine::updateLFORates()
{
    float sr = static_cast<float> (sampleRate_);
...
class MediumGatePresetWrapper : public PresetEngineBase
{
public:
    MediumGatePresetWrapper() = default;
    ~MediumGatePresetWrapper() override = default;
...
private:
    MediumGatePresetEngine engine_;
...
{
    return std::unique_ptr<PresetEngineBase> (new MediumGatePresetWrapper());
}

// Self-register at static init time so DuskVerbEngine can look up this preset by name
static PresetEngineRegistrar gMediumGatePresetRegistrar ("PresetMediumGate", &createMediumGatePreset);
