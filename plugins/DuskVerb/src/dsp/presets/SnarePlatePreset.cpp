...
namespace {
    ...
    // -----------------------------------------------------------------
    constexpr float kVvBassMultiply      = 0.909093f;
    constexpr float kVvTrebleMultiply    = 1.01225f;
    ...
    constexpr float kVvDelayScale        = 0.807537f;
    ...
    constexpr float kVvDecayTimeScale    = 0.951663f;
    ...
    // Max correction magnitude for this preset: 3.97 dB
    // -----------------------------------------------------------------
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { 1.20642f, 0.884918f, 1.22176f, -0.0929591f, -0.316023f, -0.208556f, -1.48565f, -1.35786f, -1.16523f, -0.889821f, -0.260119f, 0.561822f };
...
void SnarePlatePresetEngine::setFreeze (bool frozen) { frozen_ = frozen; }
void SnarePlatePresetEngine::setLateGainScale (float scale) { lateGainScale_ = scale; }
