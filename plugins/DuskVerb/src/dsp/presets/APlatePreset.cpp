...
namespace {
    ...
    // -----------------------------------------------------------------
    constexpr float kVvBassMultiply      = 0.800118f;
    constexpr float kVvTrebleMultiply    = 1.13043f;
    ...
    constexpr float kVvDecayTimeScale    = 0.886987f;
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { 1.12823f, 5.12655f, 9.93446f, 9.50175f, 11.6267f, 11.5077f, 10.6834f, 10.6166f, 7.77722f, 2.6245f, -3.52438f, -4.92301f };
...
void APlatePresetEngine::setLateGainScale (float scale) { lateGainScale_ = scale; }
