...
namespace {
    ...
    constexpr float kVvDecayTimeScale    = 1.94115f;
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { -5.21089f, -6.19362f, -6.8409f, -8.26471f, -8.95768f, -7.09646f, -5.43868f, -5.04643f, -2.27893f, 0.158213f, 1.56149f, -0.0662837f };
...
void APlatePresetEngine::setFreeze (bool frozen) { frozen_ = frozen; }
