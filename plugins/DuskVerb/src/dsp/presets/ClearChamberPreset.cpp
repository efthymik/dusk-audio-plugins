...
namespace {
    ...
    constexpr float kVvDecayTimeScale    = 0.866722f;
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { -0.612177f, 0.60154f, 0.247777f, -0.0884562f, 0.82938f, 0.728519f, 0.633989f, 0.334104f, 0.636568f, 0.703337f, 0.440219f, 0.269993f };
...
void ClearChamberPresetEngine::setFreeze (bool frozen) { frozen_ = frozen; }
