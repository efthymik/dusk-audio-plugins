...
namespace {
    ...
    constexpr float kBakedBassMultScale      = 0.99f;
    ...
    // -----------------------------------------------------------------
    constexpr float kVvBassMultiply      = 1.23873f;
    constexpr float kVvTrebleMultiply    = 0.902639f;
    ...
    constexpr float kVvDelayScale        = 0.803678f;
    ...
    constexpr float kVvDecayTimeScale    = 0.970118f;
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { -0.568918f, -0.397814f, -4.2078f, -4.78877f, -6.73079f, -7.44197f, -7.16057f, -7.57707f, -4.9908f, -3.43623f, -2.12657f, -0.169211f };
