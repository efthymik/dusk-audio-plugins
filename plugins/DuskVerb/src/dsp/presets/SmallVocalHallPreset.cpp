...
namespace {
    ...
    // -----------------------------------------------------------------
    constexpr float kVvBassMultiply      = 1.14972f;
    constexpr float kVvTrebleMultiply    = 0.795273f;
...
void SmallVocalHallPresetEngine::setFreeze (bool frozen) { frozen_ = frozen; }
