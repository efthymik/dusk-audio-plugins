...
namespace {
    ...
    constexpr float kBakedBassMultScale      = 1.06f;
    ...
    // -----------------------------------------------------------------
    constexpr float kVvBassMultiply      = 1.04879f;
    constexpr float kVvTrebleMultiply    = 0.865162f;
    ...
    constexpr float kVvDelayScale        = 1.56358f;
    ...
    constexpr float kVvDecayTimeScale    = 0.903085f;
    ...
    // Max correction magnitude for this preset: 7.24 dB
    // -----------------------------------------------------------------
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { -0.935621f, -1.72946f, -1.55098f, -2.01137f, -1.41333f, -2.03215f, -0.261468f, 0.0596568f, 0.946175f, -0.25849f, -0.875463f, 7.24423f };
...
void DrumPlatePresetEngine::setFreeze (bool frozen) { frozen_ = frozen; }
void DrumPlatePresetEngine::setLateGainScale (float scale) { lateGainScale_ = scale; }
