...
namespace {
    ...
    // -----------------------------------------------------------------
    constexpr float kVvBassMultiply      = 1.15099f;
    constexpr float kVvTrebleMultiply    = 0.929904f;
    ...
    constexpr float kVvDelayScale        = 0.873012f;
    ...
    constexpr float kVvDecayTimeScale    = 1.05422f;
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { 4.37435f, 0.628805f, -3.08341f, -0.778008f, -2.85871f, -0.42447f, -0.501103f, -1.19898f, -0.736803f, 0.105984f, -2.70711f, 0.935364f };
...
void RichChamberPresetEngine::setFreeze (bool frozen) { frozen_ = frozen; }
void RichChamberPresetEngine::setLateGainScale (float scale) { lateGainScale_ = scale; }
