...
namespace {
    ...
    constexpr float kVvDecayTimeScale    = 0.855728f;
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { -0.933401f, -0.195825f, -1.02821f, 0.0139983f, -0.596305f, -1.04768f, -0.81641f, -0.996355f, -0.448502f, -0.793589f, -1.26535f, 3.52148f };
...
void LargePlatePresetEngine::setFreeze (bool frozen) { frozen_ = frozen; }
