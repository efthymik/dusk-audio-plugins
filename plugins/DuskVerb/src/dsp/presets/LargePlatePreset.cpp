...
namespace {
    ...
    // -----------------------------------------------------------------
    constexpr float kVvBassMultiply      = 0.9489f;
    constexpr float kVvTrebleMultiply    = 0.848909f;
    ...
    constexpr float kVvDelayScale        = 1.56381f;
    ...
    constexpr float kVvDecayTimeScale    = 0.856082f;
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { -2.40001f, -6.45461f, -7.6522f, -2.79627f, 7.47812f, 12.0f, 12.0f, 12.0f, 12.0f, 12.0f, 12.0f, 12.0f };
...
void LargePlatePresetEngine::setLateGainScale (float scale) { lateGainScale_ = scale; }
