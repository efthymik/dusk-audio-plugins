...
namespace {
    ...
    constexpr float kVvDecayTimeScale    = 0.855266f;
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { 0.0222667f, 0.169546f, -0.157829f, 0.909367f, 0.435936f, 0.156206f, -0.452776f, -0.264823f, -1.054f, -2.08474f, -1.63184f, 8.15596f };
...
void LargeAmbiencePresetEngine::setFreeze (bool frozen) { frozen_ = frozen; }
