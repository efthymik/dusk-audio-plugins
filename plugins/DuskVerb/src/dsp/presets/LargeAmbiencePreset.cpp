...
namespace {
    ...
    constexpr float kBakedBassMultScale      = 0.9f;
    ...
    constexpr float kVvDelayScale        = 1.38396f;
    ...
    constexpr float kVvDecayTimeScale    = 0.675857f;
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { 2.15749f, 0.572348f, -4.17075f, 0.505193f, -0.749944f, 0.108104f, -1.23724f, 0.1429f, -0.128605f, -1.5406f, 3.77685f, 12.0f };
