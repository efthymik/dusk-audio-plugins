...
namespace {
    ...
    // -----------------------------------------------------------------
    constexpr float kVvBassMultiply      = 1.13979f;
    constexpr float kVvTrebleMultiply    = 0.915402f;
    ...
    constexpr float kVvDecayTimeScale    = 0.860605f;
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { -0.698406f, -6.10152f, -8.79956f, -4.01847f, 6.9639f, 12.0f, 12.0f, 12.0f, 12.0f, 12.0f, 12.0f, 12.0f };
...
void LargeAmbiencePresetEngine::setLateGainScale (float scale) { lateGainScale_ = scale; }
