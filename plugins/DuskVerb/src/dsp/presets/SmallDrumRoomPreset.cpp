...
namespace {
    ...
    constexpr float kVvDelayScale        = 0.537708f;
    ...
    constexpr float kVvDecayTimeScale    = 0.226327f;
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { -1.54224f, -12.0f, -12.0f, -12.0f, -12.0f, -12.0f, -12.0f, -12.0f, -12.0f, -12.0f, 12.0f, 12.0f };
