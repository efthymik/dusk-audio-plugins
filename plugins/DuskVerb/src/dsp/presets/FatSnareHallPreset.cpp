...
namespace {
    ...
    // -----------------------------------------------------------------
    constexpr float kVvBassMultiply      = 0.944051f;
    constexpr float kVvTrebleMultiply    = 0.783125f;
    ...
    constexpr float kVvDecayTimeScale    = 0.926311f;
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { 1.19827f, -0.686155f, 0.362797f, 0.307224f, 0.653087f, 0.592945f, 0.712641f, 0.628666f, 0.161102f, 0.198063f, 1.03519f, 1.09286f };
...
void FatSnareHallPresetEngine::setFreeze (bool frozen) { frozen_ = frozen; }
void FatSnareHallPresetEngine::setLateGainScale (float scale) { lateGainScale_ = scale; }
