...
namespace {
    ...
    // -----------------------------------------------------------------
    constexpr float kVvBassMultiply      = 1.19877f;
    constexpr float kVvTrebleMultiply    = 0.82185f;
    ...
    constexpr float kVvDelayScale        = 0.778987f;
    ...
    constexpr float kVvDecayTimeScale    = 1.11511f;
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { 12.0f, 12.0f, 12.0f, 12.0f, 4.891f, -3.7536f, -8.92735f, -10.8513f, -11.9625f, -12.0f, -4.66397f, 0.690303f };
...
void LongDark70sSnareRoomPresetEngine::setLateGainScale (float scale) { lateGainScale_ = scale; }
