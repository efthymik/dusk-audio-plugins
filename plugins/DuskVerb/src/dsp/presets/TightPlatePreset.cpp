...
namespace {
    ...
    constexpr float kBakedBassMultScale      = 1.35f;
    ...
    // -----------------------------------------------------------------
    constexpr float kVvBassMultiply      = 1.07624f;
    constexpr float kVvTrebleMultiply    = 0.77288f;
    ...
    constexpr float kVvDelayScale        = 0.881777f;
    ...
    constexpr float kVvDecayTimeScale    = 1.13586f;
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { -0.599875f, 0.915451f, -0.344893f, -1.18783f, -0.170947f, 0.813225f, 0.0597558f, 0.711741f, 1.8381f, 1.24389f, 1.24912f, 7.53226f };
...
void TightPlatePresetEngine::setFreeze (bool frozen) { frozen_ = frozen; }
void TightPlatePresetEngine::setLateGainScale (float scale) { lateGainScale_ = scale; }
