...
namespace {
    ...
    constexpr float kBakedBassMultScale      = 0.97f;
    ...
    // -----------------------------------------------------------------
    constexpr float kVvBassMultiply      = 1.01613f;
    constexpr float kVvTrebleMultiply    = 0.963263f;
    ...
    constexpr float kVvDelayScale        = 2.00006f;
    ...
    constexpr float kVvDecayTimeScale    = 0.96745f;
    ...
    // Max correction magnitude for this preset: 3.57 dB
    // -----------------------------------------------------------------
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { -2.34398f, -2.53222f, -3.56683f, -1.35908f, -1.88477f, -0.799594f, -0.256627f, 0.247333f, 0.971239f, -0.500271f, -2.32414f, -1.20397f };
...
void DarkVocalRoomPresetEngine::setFreeze (bool frozen) { frozen_ = frozen; }
void DarkVocalRoomPresetEngine::setLateGainScale (float scale) { lateGainScale_ = scale; }
