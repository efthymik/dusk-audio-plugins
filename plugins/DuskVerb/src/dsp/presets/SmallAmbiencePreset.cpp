...
namespace {
    ...
    constexpr float kBakedBassMultScale      = 1.14f;
    ...
    // -----------------------------------------------------------------
    constexpr float kVvBassMultiply      = 1.13931f;
    constexpr float kVvTrebleMultiply    = 0.929074f;
    ...
    constexpr float kVvDelayScale        = 0.795328f;
    ...
    constexpr float kVvStereoWidth       = 0.910172f;
    ...
    constexpr float kVvDecayTimeScale    = 1.10307f;
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { 0.231023f, 0.302973f, 0.441778f, 0.98618f, 0.596948f, 0.774904f, -0.581704f, 0.00649746f, -0.595303f, -1.52842f, -2.30426f, 5.03735f };
...
void SmallAmbiencePresetEngine::setFreeze (bool frozen) { frozen_ = frozen; }
void SmallAmbiencePresetEngine::setLateGainScale (float scale) { lateGainScale_ = scale; }
