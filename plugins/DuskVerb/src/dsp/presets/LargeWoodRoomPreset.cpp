...
namespace {
    ...
    // -----------------------------------------------------------------
    constexpr float kVvBassMultiply      = 0.951817f;
    constexpr float kVvTrebleMultiply    = 1.02392f;
    ...
    constexpr float kVvDecayTimeScale    = 0.689503f;
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { -4.3414f, -9.87429f, -6.86972f, -4.62284f, 5.33f, 5.33f, 5.33f, 5.33f, 5.33f, 5.33f, 5.33f, 5.33f };
