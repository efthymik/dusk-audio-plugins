...
namespace {
    ...
    constexpr float kVvDecayTimeScale    = 0.967824f;
    ...
    // Max correction magnitude for this preset: 3.30 dB
    // -----------------------------------------------------------------
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { 0.0435038f, -2.09589f, -0.673045f, -1.33009f, -1.05069f, -0.824431f, 2.21746f, 3.30468f, 3.02139f, 1.97568f, 0.0279749f, -2.41881f };
