...
namespace {
    ...
    // -----------------------------------------------------------------
    constexpr float kVvBassMultiply      = 1.12074f;
    constexpr float kVvTrebleMultiply    = 0.742975f;
    ...
    constexpr float kVvDelayScale        = 1.66339f;
    ...
    constexpr float kVvDecayTimeScale    = 0.770218f;
    ...
    // Max correction magnitude for this preset: 4.29 dB
    // -----------------------------------------------------------------
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { 0.594227f, -0.539063f, -1.67995f, -1.98881f, -1.68803f, -0.853857f, -0.486434f, -0.413808f, -0.240518f, -2.28631f, -4.29133f, -2.50469f };
...
void FatDrumsPresetEngine::setFreeze (bool frozen) { frozen_ = frozen; }
void FatDrumsPresetEngine::setLateGainScale (float scale) { lateGainScale_ = scale; }
