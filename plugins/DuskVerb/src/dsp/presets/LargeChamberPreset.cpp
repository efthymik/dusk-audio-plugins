...
namespace {
    ...
    constexpr float kBakedBassMultScale      = 0.91f;
    ...
    constexpr float kVvDelayScale        = 0.717582f;
    constexpr float kVvTiltLowDb         = -1.21994f;
    constexpr float kVvTiltLowHz         = 400.0f;
    constexpr float kVvTiltHighDb        = -2.54037f;
    ...
    constexpr float kVvDecayTimeScale    = 0.718052f;
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { -0.26823f, -1.40467f, -0.443764f, -0.914943f, 0.725273f, -0.00512939f, 0.133243f, 0.612474f, 1.18742f, 1.10608f, -0.530316f, 3.37037f };
...
void LargeChamberPresetEngine::setFreeze (bool frozen) { frozen_ = frozen; }
void LargeChamberPresetEngine::setLateGainScale (float scale) { lateGainScale_ = scale; }
