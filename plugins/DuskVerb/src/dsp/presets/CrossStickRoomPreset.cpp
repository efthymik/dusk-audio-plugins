...
namespace {
    ...
    constexpr float kVvTiltHighDb        = -3.47845f;
    ...
    constexpr float kVvDecayTimeScale    = 0.677524f;
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { 0.348016f, -5.81671f, -1.68726f, -3.66746f, -4.72213f, -4.81018f, -4.36151f, -4.18058f, -3.52985f, -3.5179f, -3.68031f, 2.74376f };
