...
namespace {
    ...
    // -----------------------------------------------------------------
    constexpr float kVvBassMultiply      = 0.965528f;
    constexpr float kVvTrebleMultiply    = 1.02825f;
    ...
    constexpr float kVvDecayTimeScale    = 0.579395f;
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { 1.8343f, -8.24914f, -5.8691f, -6.76588f, 5.29719f, 12.0f, 12.0f, 12.0f, 12.0f, 12.0f, 12.0f, 12.0f };
