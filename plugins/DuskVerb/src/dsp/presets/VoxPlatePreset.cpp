...
namespace {
    ...
    constexpr float kBakedSizeRangeMin       = 0.710075f;
    constexpr float kBakedSizeRangeMax       = 2.130225f;
    ...
    constexpr float kBakedBassMultScale      = 1.0f;  // un-baked from 1.18f — bass knob now shows real multiplier
    ...
    constexpr float kVvAirDampingScale   = 0.783462f;
    constexpr float        kVvDelayScale        = 1.0f;  // un-baked from 1.42015f — size range now absolute
    constexpr float kVvTiltLowDb         = -2.06861f;
    constexpr float kVvTiltLowHz         = 400.0f;
    constexpr float kVvTiltHighDb        = -2.6271f;
    constexpr float kVvTiltHighHz        = 5000.0f;
    constexpr float kVvStereoWidth       = 0.87649f;
    ...
    constexpr float kVvDecayTimeScale    = 1.0f;   // un-baked from 1.04358f
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { -0.292153f, -4.93752f, -1.97453f, -1.04474f, -3.45433f, -3.40352f, -2.6988f, -2.90892f, -1.51785f, -4.05758f, -7.53649f, 12.0f };
...
void VoxPlatePresetEngine::setLateGainScale (float scale) { lateGainScale_ = std::max (scale, 0.0f); }
