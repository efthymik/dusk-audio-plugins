...
namespace {
    ...
    constexpr float kBakedBassMultScale      = 1.18f;
    ...
    // -----------------------------------------------------------------
    constexpr float kVvBassMultiply      = 1.06831f;
    constexpr float kVvTrebleMultiply    = 0.86589f;
    ...
    constexpr float kVvDelayScale        = 1.42015f;
    constexpr float kVvTiltLowDb         = -2.06861f;
    constexpr float kVvTiltLowHz         = 400.0f;
    constexpr float kVvTiltHighDb        = -2.62709f;
    ...
    constexpr float kVvDecayTimeScale    = 1.00808f;
    ...
    constexpr float kCorrEqDb[kCorrEqBandCount] = { -1.69617f, -2.36126f, -1.01438f, -0.42696f, -0.4497f, 0.231461f, 0.56179f, 0.51089f, 1.6856f, 0.787867f, -0.292729f, 5.39923f };
...
void VoxPlatePresetEngine::setFreeze (bool frozen) { frozen_ = frozen; }
void VoxPlatePresetEngine::setLateGainScale (float scale) { lateGainScale_ = scale; }
