...
// Seed lives on the HallReverb instance so two reverbs on the same bus see
...
HallReverb::HallReverb()
{
    ...
    // Per-instance Householder reflector seed. Each HallReverb gets a distinct
...
void HallReverb::seedHouseholderVectors (uint32_t seed)
{
    auto next01 = [&seed]() {
...
// ---------------------------------------------------------------------------
void HallReverb::publishPending()
{
...
void HallReverb::setBaseDelays (const int* delays)
{
...
void HallReverb::setOutputTaps (const int* lt, const int* rt,
...
void HallReverb::setLateGainScale (float scale)
{
    pending().lateGainScale = std::max (scale, 0.0f);
    publishPending();
}

void HallReverb::setSizeRange (float min, float max)
{
...
void HallReverb::setUseShortInlineAP (bool use)
{
    pending().useShortInlineAP = use;
    publishPending();
}

void HallReverb::setMultiPointOutput (const HallOutputTap* left, int numL,
                                     const HallOutputTap* right, int numR)
{
...
void HallReverb::setMultiPointDensity (int tapsPerChannel)
{
...
void HallReverb::setHadamardPerturbation (float amount)
{
    if (amount <= 0.0f)
    {
...
void HallReverb::setUseHouseholder (bool enable)
{
    pending().useHouseholder = enable;
    publishPending();
}

void HallReverb::setUseWeightedGains (bool enable)
{
...
void HallReverb::setDualSlope (float ratio, int fastCount, float fastGain)
{
...
void HallReverb::setStereoCoupling (float amount)
{
    LiveParams& p = pending();
    if (amount < 0.0f)
    {
...
void HallReverb::setModDepthFloor (float floor)
{
...
void HallReverb::setAirTrebleMultiply (float mult)
{
...
void HallReverb::setStructuralHFDamping (float baseFreqHz, float trebleMultiply)
{
...
void HallReverb::setStructuralLFDamping (float hz)
{
    LiveParams& p = pending();
    if (hz <= 0.0f)
    {
...
void HallReverb::setDecayBoost (float boost)
{
...
// Snapshot derivation
// ===========================================================================
void HallReverb::computeDelayLengths (LiveParams& p)
{
...
void HallReverb::computeDecayCoefficients (LiveParams& p)
{
...
void HallReverb::updateModDepth()
{
    float rateRatio = static_cast<float> (sampleRate_ / kBaseSampleRate);
...
void HallReverb::updateLFORates()
{
