#!/usr/bin/env python3
"""
Comprehensive DuskVerb vs ReferenceReverb comparison across ALL modes.

Tests each DuskVerb algorithm against its closest ReferenceReverb equivalent
...
ReferenceReverb mode mapping (v4.0.5 — 22 modes, step 1/24):
...
# ---------------------------------------------------------------------------
# ReferenceReverb neutral base (shared across all presets)
...
MODES = [
    # -----------------------------------------------------------------------
    # HALL → ReferenceReverb Concert Hall (0.0417)
    # -----------------------------------------------------------------------
    {
        "dv_mode": "Hall",
        "presets": [
            {
                ...
                "reference": vv_preset(0.0417, 0.50, 0.70, 0.30, 0.25, 20.0,
                                      decay_hint=0.10),
            },
            {
                "name": "Hall-Medium",
                ...
                "reference": vv_preset(0.0417, 0.70, 0.75, 0.35, 0.30, 30.0,
                                      decay_hint=0.18),
            },
            {
                "name": "Hall-Long",
                "duskverb": dv_preset("Hall", 5.0, 0.85, 0.80, 0.40, 0.9,
                                      ...
                                      width=1.2),
                "reference": vv_preset(0.0417, 0.85, 0.80, 0.40, 0.35, 40.0,
                                      decay_hint=0.30),
            },
        ],
    },
    ...
    # -----------------------------------------------------------------------
    # PLATE → ReferenceReverb Plate (0.0833)
    # -----------------------------------------------------------------------
    {
        "dv_mode": "Plate",
        "presets": [
            {
                ...
                "duskverb": dv_preset("Plate", 1.0, 0.45, 0.80, 0.20, 0.5,
                                      0.0),
                "reference": vv_preset(0.0833, 0.45, 0.80, 0.20, 0.15, 0.0,
                                      decay_hint=0.08),
            },
            {
                "name": "Plate-Medium",
                "duskverb": dv_preset("Plate", 2.0, 0.65, 0.85, 0.25, 0.6,
                                      0.0),
                "reference": vv_preset(0.0833, 0.65, 0.85, 0.25, 0.20, 0.0,
                                      decay_hint=0.15),
            },
            {
                "name": "Plate-Long",
                "duskverb": dv_preset("Plate", 4.0, 0.80, 0.90, 0.30, 0.7,
                                      0.0),
                "reference": vv_preset(0.0833, 0.80, 0.90, 0.30, 0.25, 0.0,
                                      decay_hint=0.25),
            },
        ],
    },
    ...
    # -----------------------------------------------------------------------
    # ROOM → ReferenceReverb Room (0.1250)
        ...
        "presets": [
            {
                ...
                "reference": vv_preset(0.1250, 0.50, 0.70, 0.30, 0.25, 10.0,
                                      decay_hint=0.50),
            },
            {
                "name": "Room-Medium",
                ...
                "reference": vv_preset(0.1250, 0.70, 0.75, 0.35, 0.30, 20.0,
                                      decay_hint=0.60),
            },
            {
                "name": "Room-Long",
                "duskverb": dv_preset("Room", 25.0, 0.85, 0.80, 0.40, 0.5,
                                      ...
                                      width=1.2),
                "reference": vv_preset(0.1250, 0.85, 0.80, 0.40, 0.35, 30.0,
                                      decay_hint=0.70),
            },
        ],
    },
    ...
    # -----------------------------------------------------------------------
    # CHAMBER → ReferenceReverb Chamber (0.1667)
    # -----------------------------------------------------------------------
    {
        "dv_mode": "Chamber",
        "presets": [
            {
                ...
                "reference": vv_preset(0.1667, 0.45, 0.70, 0.25, 0.22, 10.0,
                                      decay_hint=0.08),
            },
            {
                "name": "Chamber-Medium",
                ...
                "reference": vv_preset(0.1667, 0.60, 0.75, 0.30, 0.25, 20.0,
                                      decay_hint=0.14),
            },
        ],
    },
    ...
    # -----------------------------------------------------------------------
    # AMBIENT → ReferenceReverb Ambience (0.2917)
    # -----------------------------------------------------------------------
    {
        "dv_mode": "Ambient",
        "presets": [
            {
                ...
                "duskverb": dv_preset("Ambient", 8.0, 0.80, 0.90, 0.45, 0.8,
                                      30.0, width=1.4),
                "reference": vv_preset(0.2917, 0.80, 0.90, 0.45, 0.35, 30.0,
                                      decay_hint=0.60),
            },
            {
                "name": "Ambient-Medium",
                "duskverb": dv_preset("Ambient", 6.0, 0.85, 0.95, 0.50, 0.9,
                                      40.0, width=1.6),
                "reference": vv_preset(0.2917, 0.85, 0.95, 0.50, 0.40, 40.0,
                                      decay_hint=0.35),
            },
            {
                "name": "Ambient-Subtle",
                "duskverb": dv_preset("Ambient", 4.0, 0.65, 0.85, 0.35, 0.7,
                                      20.0, width=1.2),
                "reference": vv_preset(0.2917, 0.65, 0.85, 0.35, 0.30, 20.0,
                                      decay_hint=0.25),
            },
        ],
    },
...
def calibrate_decay_fast(plugin, target_rt60, vv_config, sr,
    ...
    for _ in range(8):
        ...
        trial["_decay"] = mid
        apply_reference_params(plugin, trial)
...
def main():
    ...
    if not dv_path or not vv_path:
        print("ERROR: Need both DuskVerb and ReferenceReverb.")
        return
        ...
        for preset in mode_def["presets"]:
            ...
            if skip_cal:
                ...
                cal_decay, cal_rt60 = calibrate_decay_fast(
                    reference_reverb, dv_rt60_500, vv_cfg, sr,
            ...
            apply_reference_params(reference_reverb, vv_cfg)
            flush_plugin(reference_reverb, sr, flush_dur)
            vv_imp_l, vv_imp_r = process_stereo(reference_reverb, impulse, sr)
            flush_plugin(reference_reverb, sr, flush_dur)
            ...
            flush_plugin(duskverb, sr, flush_dur)
            vv_tone_l, _ = process_stereo(reference_reverb, tone, sr)
            flush_plugin(reference_reverb, sr, flush_dur)
    ...
    # -----------------------------------------------------------------------
    print(f"\n{'='*100}")
    print(f"  SUMMARY: DuskVerb vs ReferenceReverb (All Modes, Matched Parameters)")
    print(f"{'='*100}")
