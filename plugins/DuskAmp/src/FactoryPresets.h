...
struct DuskAmpPreset
{
    ...
    int    ampType;           // 0=Clean, 1=British Crunch, 2=British Chime
    float  inputGain;         // dB
...
{
    // === CLEAN ===
    { "Clean",                  "Clean",    0, 0, 0, -60, 50, 0.2f, false,  0.6f, 0.5f, 0.6f, 0.2f, 0.5f, 0.5f, 0.2f,  false, 0.5f, 0.5f, 0.5f,  1, 12000, 60,  0, 0, 0, 0,  0, 0, 0, 0.5f, 0.5f,  0 },
    { "Sparkle",                "Clean",    0, 0, 0, -60, 50, 0.25f, true,  0.5f, 0.5f, 0.7f, 0.2f, 0.6f, 0.4f, 0.3f,  false, 0.5f, 0.5f, 0.5f,  1, 12000, 60,  0, 0, 0, 0,  0, 0, 0, 0.5f, 0.5f,  0 },
    { "Edge of Breakup",        "Clean",    0, 0, 0, -55, 40, 0.55f, false, 0.6f, 0.4f, 0.5f, 0.3f, 0.5f, 0.5f, 0.4f,  false, 0.5f, 0.5f, 0.5f,  1, 11000, 70,  0, 0, 0, 0,  0, 0, 0, 0.5f, 0.5f,  0 },
    { "Blues Clean",            "Clean",    0, 0, 0, -55, 40, 0.65f, true,  0.6f, 0.4f, 0.5f, 0.35f, 0.4f, 0.5f, 0.4f, true, 0.3f, 0.6f, 0.5f,   1, 11000, 70,  0, 0, 0, 0,  0, 0, 0, 0.5f, 0.5f,  0 },
    { "Country Twang",          "Clean",    0, 0, 0, -60, 50, 0.3f, true,  0.5f, 0.6f, 0.7f, 0.2f, 0.6f, 0.4f, 0.2f,  false, 0.5f, 0.5f, 0.5f,  1, 12000, 60,  0, 0, 0, 0,  0, 0, 0, 0.5f, 0.5f,  0 },
    { "Clean Ambient",          "Clean",    0, 0, 0, -60, 50, 0.2f, false, 0.5f, 0.5f, 0.6f, 0.2f, 0.5f, 0.5f, 0.2f,  false, 0.5f, 0.5f, 0.5f,  1, 12000, 60,  1, 400, 0.3f, 0.25f,  0.2f, 0.6f, 30, 0.5f, 0.6f,  0 },

    // === CHIME ===
    { "Chime",                  "Chime",    0, 2, 0, -60, 50, 0.3f, false,  0.4f, 0.6f, 0.7f, 0.2f, 0.6f, 0.4f, 0.2f,  false, 0.5f, 0.5f, 0.5f,  1, 12000, 60,  0, 0, 0, 0,  0, 0, 0, 0.5f, 0.5f,  0 },
    { "Jangle",                 "Chime",    0, 2, 0, -60, 50, 0.4f, false,  0.4f, 0.7f, 0.7f, 0.25f, 0.5f, 0.4f, 0.2f, false, 0.5f, 0.5f, 0.5f,  1, 11000, 60,  0, 0, 0, 0,  0, 0, 0, 0.5f, 0.5f,  0 },
    { "Chime Crunch",           "Chime",    0, 2, 0, -55, 40, 0.6f, false,  0.5f, 0.7f, 0.6f, 0.3f, 0.5f, 0.5f, 0.3f,  false, 0.5f, 0.5f, 0.5f,  1, 10000, 80,  0, 0, 0, 0,  0, 0, 0, 0.5f, 0.5f,  0 },
    { "Desert Crunch",          "Chime",    0, 2, 0, -55, 40, 0.5f, false,  0.5f, 0.6f, 0.6f, 0.3f, 0.5f, 0.5f, 0.3f,  true, 0.4f, 0.6f, 0.5f,   1, 10000, 70,  0, 0, 0, 0,  0, 0, 0, 0.5f, 0.5f,  0 },
    { "Boost Lead",             "Chime",    0, 2, 0, -50, 35, 0.75f, false, 0.5f, 0.7f, 0.6f, 0.4f, 0.6f, 0.5f, 0.3f,  true, 0.5f, 0.5f, 0.5f,  1, 9500, 80,   0, 0, 0, 0,  0, 0, 0, 0.5f, 0.5f,  0 },
    { "Chime Shimmer",          "Chime",    0, 2, 0, -60, 50, 0.25f, false, 0.4f, 0.6f, 0.7f, 0.2f, 0.5f, 0.4f, 0.2f,  false, 0.5f, 0.5f, 0.5f,  1, 12000, 60,  1, 350, 0.25f, 0.2f,  0.25f, 0.7f, 40, 0.4f, 0.7f,  0 },

    // === CRUNCH ===
    { "Stack Clean",            "Crunch",   0, 1, 0, -60, 50, 0.2f, false,  0.5f, 0.5f, 0.5f, 0.2f, 0.5f, 0.5f, 0.2f,  false, 0.5f, 0.5f, 0.5f,  1, 12000, 60,  0, 0, 0, 0,  0, 0, 0, 0.5f, 0.5f,  0 },
    { "Crunch",                 "Crunch",   0, 1, 0, -60, 50, 0.5f, false,  0.5f, 0.6f, 0.5f, 0.3f, 0.5f, 0.5f, 0.3f,  false, 0.5f, 0.5f, 0.5f,  1, 10000, 80,  0, 0, 0, 0,  0, 0, 0, 0.5f, 0.5f,  0 },
    { "Classic Rock",           "Crunch",   0, 1, 0, -55, 40, 0.7f, true,   0.6f, 0.7f, 0.5f, 0.4f, 0.5f, 0.5f, 0.3f,  false, 0.5f, 0.5f, 0.5f,  1, 10000, 80,  0, 0, 0, 0,  0, 0, 0, 0.5f, 0.5f,  0 },
    { "Classic Lead",           "Crunch",   0, 1, 0, -50, 35, 0.8f, false,  0.5f, 0.7f, 0.6f, 0.4f, 0.6f, 0.5f, 0.3f,  false, 0.5f, 0.5f, 0.5f,  1, 9000, 80,   0, 0, 0, 0,  0, 0, 0, 0.5f, 0.5f,  0 },
    { "Hot Rod",                "Crunch",   0, 1, 2, -50, 30, 0.85f, true,  0.5f, 0.6f, 0.6f, 0.5f, 0.6f, 0.5f, 0.3f,  true, 0.5f, 0.5f, 0.5f,  1, 9000, 90,   0, 0, 0, 0,  0, 0, 0, 0.5f, 0.5f,  0 },
    { "High Gain",              "Crunch",   0, 1, 2, -50, 30, 0.9f, false,  0.6f, 0.5f, 0.6f, 0.5f, 0.7f, 0.6f, 0.2f,  true, 0.6f, 0.5f, 0.5f,  1, 8000, 100,  0, 0, 0, 0,  0, 0, 0, 0.5f, 0.5f,  0 },
    { "Shred",                  "Crunch",   0, 1, 2, -45, 25, 1.0f, true,   0.5f, 0.6f, 0.7f, 0.5f, 0.7f, 0.5f, 0.2f,  true, 0.7f, 0.5f, 0.5f,  1, 8500, 90,   0, 0, 0, 0,  0, 0, 0, 0.5f, 0.5f,  1 },
    { "Sludge",                 "Crunch",   0, 1, 0, -50, 30, 0.9f, false,  0.7f, 0.4f, 0.4f, 0.5f, 0.4f, 0.7f, 0.4f,  true, 0.5f, 0.3f, 0.5f,  1, 7000, 100,  0, 0, 0, 0,  0, 0, 0, 0.5f, 0.5f,  0 },
