...
namespace DuskAmpParams
{
    ...
    static constexpr const char* AMP_MODEL       = "amp_model";
    ...
    static constexpr const char* POWER_AMP_ENABLED = "power_amp_enabled";
    ...
    static constexpr const char* CAB_AUTOGAIN    = "cab_autogain";
    ...
    static constexpr const char* NAM_INPUT_LEVEL  = "nam_input_level";
    static constexpr const char* NAM_OUTPUT_LEVEL = "nam_output_level";
