...
// Dusk Audio - Shared Vintage Look and Feel
// Base class for vintage-style plugin interfaces
class DuskVintageLookAndFeel : public juce::LookAndFeel_V4
{
public:
    // Color constants
...
using DuskLookAndFeel = DuskVintageLookAndFeel;
